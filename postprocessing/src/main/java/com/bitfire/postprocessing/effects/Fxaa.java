...
/**
 * Implements the fast approximate anti-aliasing. Very fast and useful for
 * combining with other post-processing effects.
...
public final class Fxaa extends PostProcessorEffect {
    ...
    /** Creatie a Fxaa with the viewport size */
